      ...
      >
        <nav className="px-4 py-6 space-y-4" aria-label="Mobile Navigation">
          ...
          <div className="pt-4 space-y-3 border-t border-gray-200">
            ...
            <Link
              href="/beispiel-analyse"
              className="block w-full text-center border-2 border-brand-brown text-brand-brown px-4 py-3 rounded-lg hover:bg-amber-50 transition-colors font-medium shadow-md"
              onClick={closeMenu}
            >
              Beispiel-Analyse
            </Link>
