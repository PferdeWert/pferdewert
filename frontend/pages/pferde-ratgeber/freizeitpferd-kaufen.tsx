      ...
      <article>
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-6 space-y-12">
          ...
          <section className="space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Nach der Lektüre kennst du die wichtigsten Kriterien, erfährst welche Rassen optimal sind, erhältst eine detaillierte Kostenübersicht, und weißt, wie du dein Traumpferd sicher kaufst. Einen umfassenden Überblick über den gesamten Pferdekauf-Prozess findest du in unserem <Link href="/pferde-ratgeber/pferd-kaufen" className="text-brand hover:text-brand-dark underline">ultimativen Pferdekauf-Ratgeber</Link>.
            </p>
          </section>
          ...
          <section id="kaufprozess" className="scroll-mt-32 lg:scroll-mt-40 space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Einen detaillierten Überblick über Online-Plattformen, traditionelle Pferdemärkte und Veranstaltungskalender findest du in unserem <Link href="/pferde-ratgeber/pferdemarkt" className="text-brand hover:text-brand-dark underline">Pferdemarkt-Guide</Link>.
            </p>
          </section>
          ...
          <section id="gesundheit" className="scroll-mt-32 lg:scroll-mt-40 space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Weitere Details zur Ankaufsuntersuchung findest du in unserem umfassenden <Link href="/pferde-ratgeber/aku-pferd" className="text-brand hover:text-brand-dark underline">AKU-Ratgeber</Link>.
            </p>
          ...
          <section id="rechtliches" className="scroll-mt-32 lg:scroll-mt-40 space-y-6">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Detaillierte Informationen und kostenlose Vertragsvorlagen findest du in unserem <Link href="/pferde-ratgeber/pferdekaufvertrag" className="text-brand hover:text-brand-dark underline">Pferdekaufvertrag-Ratgeber</Link>.
            </p>
          </section>
