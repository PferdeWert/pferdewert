// pages/pferde-ratgeber/pferd-kaufen.tsx
...
export default function PferdKaufen({ lastModified }: Props) {
  const kauftipps = [
    {
  ...
  return (
    <Layout>
      <>
        ...
        {/* Localization */}
        <link rel="alternate" hrefLang="de-DE" href="https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen" />
        <link rel="alternate" hrefLang="x-default" href="https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen" />
        ...
        <meta property="og:description" content="Pferd kaufen? Nutze den Pferdepreis-Rechner und finde faire Angebote in NRW, Bayern & deutschlandweit ✓ Keine Überzahlung ✓ Sofort-Analyse in 2 Min" />
         ...
         <meta property="og:url" content="https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen" />
         <meta property="og:image" content="https://www.pferdewert.de/images/blossi-5.webp" />
        ...
        <meta name="twitter:description" content="Pferd kaufen? Nutze den Pferdepreis-Rechner und finde faire Angebote in NRW, Bayern & deutschlandweit ✓ Keine Überzahlung ✓ Sofort-Analyse in 2 Min" />
         <meta name="twitter:image" content="https://www.pferdewert.de/images/blossi-5.webp" />
         
          {/* Consolidated Structured Data für SEO */}
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "@graph": [
                  {
                    "@type": "WebPage",
                    "@id": "https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen",
                    ...
                    "mainEntity": {
                      ...
                      "description": "KI-gestützte Pferdebewertung in 2 Minuten",
                      "provider": {
                        "@type": "Organization",
                        "name": "PferdeWert",
                  ...
                  {
                    "@type": "FAQPage",
                    "@id": "https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen#faq",
                    "mainEntity": [
                      {
                        "@type": "Question",
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Ja, absolut! Gib einfach die Daten des Pferdes ein, das du kaufen möchtest. Du erhältst eine objektive Preiseinschätzung, die dir bei der Verhandlung hilft."
                        }
                      },
                      {
                        "@type": "Question",
                      ...
                      {
                        "@type": "Question",
                        "name": "Was ist, wenn der Verkäufer deutlich mehr verlangt?",
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Das kann verschiedene Gründe haben: Besondere Qualitäten, emotionaler Wert oder unrealistische Preisvorstellung. Die Bewertung hilft dir zu entscheiden, ob der Aufpreis gerechtfertigt ist."
                        }
                      }
                    ]
                  },
                  {
                    "@type": "BreadcrumbList",
                    "@id": "https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen#breadcrumb",
                    "itemListElement": [
                      {
                        "@type": "ListItem",
                        "position": 1,
                      ...
                      },
                      {
                        ...
                        "position": 3,
                        "name": "Pferd kaufen",
                        "item": "https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen"
                      }
                    ]
                  }
                ]
          ...
          />
          <link rel="canonical" href="https://www.pferdewert.de/pferde-ratgeber/pferd-kaufen" />
        </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  info('Generating static props for pferde-ratgeber/pferd-kaufen');
