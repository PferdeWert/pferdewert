  ...
  return (
    <Layout fullWidth={true} background="bg-gradient-to-b from-amber-50 to-white">
      <Head>
        ...
        <meta
          name="description"
          content="🐎 Team PferdeWert: Pferdefamilie mit KI-Expertise für ${PRICING_FORMATTED.current} ➤ Transparent & fair ✓ Von Reitern für Reiter ✓ Vertrauenswürdig ✓ Mehr erfahren!"
        />
